...
- [ ] Inventario reale (in attesa di "procedi"): collegare la UI KDS approvata alla logica esistente; preferiti aziendali condivisi sui prodotti propri; apertura/chiusura solo amministratore, conteggio anche agli operatori; un solo inventario generale con avanzamento per zona
