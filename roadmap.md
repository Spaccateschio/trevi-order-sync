...
- [ ] FASE D — riconciliazione conteggio fisico ↔ lotti: differenza = giacenza fisica − somma disponibilità teoriche dei lotti, non attribuita e visibile come anomalia; nessuna assegnazione automatica (no FIFO, no fornitore inventato); schermata di riconciliazione eventualmente successiva
- [ ] FASE D — implementazione approvata: ordini fornitore, consegne dichiarate, confronto, contestazioni, carico merce, lotti, movimenti append-only, riconciliazione visibile + 19 test
