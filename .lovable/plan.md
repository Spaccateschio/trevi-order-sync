...
4. **Rapporti commerciali**: la tabella dei rapporti continua a esistere con la stessa struttura e gli stessi stati, ma punta due volte alla stessa anagrafica: lato venditore e lato acquirente. Vincolo che impedisce un rapporto con se stessa.
...
8. **Registrazione azienda**: la funzione che registra l'azienda dal frontend accetta la capacità scelta, crea l'azienda, iscrive l'utente come amministratore e — se l'azienda acquista e esiste un venditore — apre la richiesta di collegamento in attesa. Ogni passaggio resta tracciato nel registro attività.
